...
| [`zhongkechen/durable-execution-ts`](https://github.com/zhongkechen/durable-execution-ts) (`community/typescript`) | TypeScript (Node.js 22+) | Conformance-tested | [![Build](https://github.com/zhongkechen/durable-execution-ts/actions/workflows/build.yml/badge.svg)](https://github.com/zhongkechen/durable-execution-ts/actions/workflows/build.yml) [![Conformance](https://github.com/zhongkechen/durable-execution-ts/actions/workflows/conformance-tests.yml/badge.svg)](https://github.com/zhongkechen/durable-execution-ts/actions/workflows/conformance-tests.yml) | TypeScript-native fork of the AWS JavaScript SDK with strict TypeScript sources, ESM and CommonJS builds, and the independent `durable-execution-ts` package family. Runs the upstream conformance suite in repository CI. |
